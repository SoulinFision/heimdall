...
/**
 * redis  token key expired 过期监听
 *
 * @author Luter
 */
@Slf4j
public class RedisKeyExpiredEventMessageListener extends KeyspaceEventMessageListener implements ApplicationEventPublisherAware {
    /**
     * The Publisher.
     */
    @Nullable
    ...
    /**
     * Instantiates a new Redis key expired event message listener.
     *
     * @param listenerContainer the listener container
     */
    public RedisKeyExpiredEventMessageListener(RedisMessageListenerContainer listenerContainer) {
