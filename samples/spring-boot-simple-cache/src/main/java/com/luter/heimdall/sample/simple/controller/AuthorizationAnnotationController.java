...
@Slf4j
@RequestMapping("/anno")
public class AuthorizationAnnotationController {
    ...
    public String requirePermission() {
        return "RequiresPermission(catSave)";
    }
    ...
    @RequiresPermissions(value = {"catSave", "catList"}, mode = Mod.ALL)
    public String requirePermissionsAll() {
        return "RequiresPermissions(catSave,catList) ALL";
    }
    ...
    @RequiresPermissions(value = {"catSave", "catList"}, mode = Mod.ANY)
    public String requirePermissionsAny() {
        return "RequiresPermissions(catSave,catList) ANY";
    }
